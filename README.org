...
#+begin_src emacs-lisp :tangle early-init.el
    ...
    ;; Detectar el sistema operativo automáticamente:
    (setq running-os (if (eq system-type 'windows-nt) "windows" "linux"))
    ...
    (cond
     ((string= running-os "linux")
      (setq user-emacs-directory   "~/.local/share/emacs/"
            ...
            org-wiki-directory "~/OpenCloud/org_roam_wiki/"))
...
#+end_src
*** Insert haskell codeblock C-c h
#+begin_src emacs-lisp
(defun insertar-bloque-haskell ()
  "Inserta un bloque de código Haskell en Org-mode."
  (interactive)
  (insert "#+begin_src haskell :results output\n  :{\n  :}\n\n#+end_src\n"))

(global-set-key (kbd "C-c h") 'insertar-bloque-haskell)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq zettelkasten-paths-alist
      (list
       ...
       (cons "NesWiki" "~/Documents/NesWiki/")))
...
(with-eval-after-load 'org
  (setq org-agenda-files (list (file-name-concat org-wiki-directory "agenda.org"))))
 #+end_src
*** Org tempo
#+begin_src emacs-lisp
  (require 'org-tempo)
...
*** My daily tracker
#+begin_src emacs-lisp
  (load (file-name-concat user-config-directory "daily.el"))
#+end_src
*** Org haskell
#+begin_src emacs-lisp
